//Rule.cpp
//        Program to demonstrate what happens when
//        the Rule of Three isn't implemented. You
//        can also comment out the copy constructor
//        and it will compile with invalid results.
#include <iostream>
#include <algorithm>
...
class Rule
{
    public:
        ...
        //Overloaded assignment operator (COMMENTED OUT)
...
/*Rule& Rule::operator =(const Rule &Rhs) (COMMENTED OUT)
{
...
int main()
{
    ...
    //Take note of the incorrect output!
    cout << "INCORRECT OUTPUT ABOVE \n";
