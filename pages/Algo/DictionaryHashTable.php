...
<body>
	...
	<div class="container-fluid">
		<div class="row mt-4">
		    <div class="col-12">
			    <h2 class="text-center heading mt-3">Dictionaries and Hash Tables</h2>
            </div>
        </div>
...
<span class="co-y">    elements</span>()
        ...
        <div class="row mb-4 pl-md-4">
            <div class="algoNotesPara col-md-9 col-12">
                <p class="co-c">Hash Functions and Hash tables</p>
...
<p class="% ml-2 mb-2"></p>
        ...
        <div class="row mb-4 pl-md-4">
            <div class="algoNotesPara col-md-9 col-12">
                <p class="co-c">Compression Maps:</p>
        ...
        <div class="row mb-4 pl-md-4">
            <div class="algoNotesPara col-md-9 col-12">
                <p class="co-c">Universal Hashing:</p>
...
<span class="co-y">    h(<span class="co-m">73</span>) = <span class="co-m">8</span> | d(<span class="co-m">73</span>) = <span class="co-m">4</span> | probes: <span class="co-c">8 --&gt; 12</span></span>
        ...
        <div class="row mb-4 pl-md-4">
            <div class="algoNotesPara col-md-9 col-12">
                <p class="co-c">Performance of Hashing</p>
        ...
        <div class="row mb-4 pl-md-4">
            <div class="algoNotesPara col-md-9 col-12">
                <p class="co-c">Chaining vs Open Addressing</p>
