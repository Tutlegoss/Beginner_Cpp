            ...
            <div class="col-auto">
        		<div class="exBoxYellow">
        			...
        			<ul>
        				...
        				<li>
        					<span class="yellow">Recall</span>: Whichever operator is furthest left gets evaluated
                            first for Multiplication/Division and Addition/Subtraction<br>
                            [e.g. <span class="co-m">2</span><span class="co-y"> / </span>
        					<span class="co-m">4</span><span class="co-y"> * </span><span class="co-m">5</span>
                            <span class="co-y"> / </span><span class="co-m">20</span> is parsed as
        					((<span class="co-m">2</span><span class="co-y"> / </span> <span class="co-m">4</span>)
                            <span class="co-y"> * </span><span class="co-m">5</span>)
        		...
        		<div class="exBoxCyan">
        			...
        			<ul>
        				...
        				<li class="mb-3">
                            ...
                            <span class="co-m">9</span>; <span class="co-m">A</span>
        				...
        				<li class="mb-3">
                            ...
                            <span class="co-m">y</span><span class="co-y"> + </span><span class="co-m">8</span>;
        					is parsed as (<span class="co-m">x</span><span class="co-y"> * </span>
                            <span class="co-m">y</span>)<span class="co-y"> + </span><span class="co-m">8</span>]
        				...
        				<li class="mb-3">
        					...
        					<br>[e.g. <span class="co-m">x</span><span class="co-y"> = </span>
                            <span class="co-m">y</span> = <span class="co-m">z</span>
        					<span class="co-y"> = </span><span class="co-m">2</span>;
        					is parsed as <span class="co-m">x</span> <span class="co-y">=</span>
                            (<span class="co-m">y</span> <span class="co-y">=</span>
        				...
        				<li class="mb-3">
                            ...
                            <span class="co-y">++ + ++</span><span class="co-m">B</span>;
        					the compiler can choose either <span class="co-m">A</span><span class="co-y">++</span>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-12">
        		...
        		<p class="ml-md-3 ml-lg-4 mr-md-3 mr-lg-4">
        			...
        			I will not be discussing all of the operators in this article save for the mathematical,
                    logical, and increment operators. <span class="co-y">Please note</span>: The precedence
                    level numbers aren't explicitly defined in the C++ standard. They are a result of the grammar.
        		</p>
        				...
        				<table class="table-dark table-responsive" id="precTable">
        					...
        					<tbody>
        						...
        						<tr>
        							...
        							<td rowspan="12">Left-to-right</td>
        						</tr>
        						<tr>
        							<td>5</td>
        							<td>
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-12">
        		...
        		<p class="ml-md-3 ml-lg-4 mr-md-3 mr-lg-4">
                    ...
                    have the same precedence <span class="co-y">(level 5)</span>. Therefore, multiplication and
                    divsion must come before addition and subtraction since the lower the level ensures a higher
                    priority. Let's start off with a simple snippet of code:
        		</p>
                <div class="row justify-content-center mb-5">
                    <div class="col-auto">
...
<p class="ml-2 mb-2">OUTPUT: 0.75</p>
        		...
        		<p class="ml-md-3 ml-lg-4 mr-md-3 mr-lg-4 mt-3">
        			...
        			<span class="green highlight">z <span class="co-y">/</span> 20.0</span> are grouped together
                    and are both evaluated before addition with a result of
        			<span class="co-m highlight">1/2</span> and
        			<span class="co-m highlight">1<span class="co-y">/</span>4</span> respectively. Therefore,
                    our expression can be written as
        			<span class="green highlight">(x <span class="co-y">/</span> y) <span class="co-y">+</span>
                    (z <span class="co-y">/</span> 20.0)</span>. We see that the evaluated division expressions
        			become the operands of the addition operator. So,
        			<span class="green highlight">1<span class="co-y">/</span>2 <span class="co-y">+</span>
                    1<span class="co-y">/</span>4 <span class="co-y">=</span> 3<span class="co-y">/</span>4</span>
                    or <span class="co-m highlight">0.75</span>. This calculates exactly as expected. Now, notice
                    I didn't specify whether
        			<span class="green highlight">x <span class="co-y">/</span> y</span> or
        			<span class="green highlight">z <span class="co-y">/</span> 20.0</span> is evaluated first.
                    If division has left-to-right associativity, then surely
        			<span class="green highlight">x <span class="co-y">/</span> y</span> is the logical choice.
...
<p class="ml-2 mb-2">OUTPUT: 4</p>
        		...
        		<p class="ml-md-3 ml-lg-4 mr-md-3 mr-lg-4 mt-3">
        			...
        			<span class="green highlight">g++ (Debian 8.3.0-6) 8.3.0</span>. On a terminal,
                    the command looks like <span class="green highlight">g++ -S program.cpp</span>. This produces
                    a .s file with the same name as your program, so in this case it will produce
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-12">
        		...
        		<p class="ml-md-3 ml-lg-4 mr-md-3 mr-lg-4">
                    ...
                    operators. However, there's no guarantee which operand is evaluated first.
        			C++ does not have any specified order of evaluation when evaluating operands to mathematical
                    operators. For example, an expression such as
        			...
        			<span class="green highlight"><span class="co-y">++</span>z</span> could be evaluated first.
        		...
        		<ul class="indent-list">
        			<li class="text-justify"><span class="co-y">Summary</span>: The operands of the subtraction
                    and addition operators have no specified order of evaluation at runtime, but the subtraction
                    and addition operators adhear to left-to-right associativity during compile-time since
                    subtraction and addition have the same precedence level
        			</li>
        		</ul>
            </div>
        </div>
...
<p class="ml-2 mb-2">OUTPUT: lhs: 1, rhs: 0</p>
        		...
        		<p class="ml-md-3 ml-lg-4 mr-md-3 mr-lg-4">
        			...
        			This is why no variable has a change of state. Even though logical AND has a higher priority,
                    that only means the logical AND operator and its two operands are bound by parenthesis
                    resuling in the aforementioned.
        		</p>
            </div>
        </div>
    ...
    <script>
    	$(document).ready(function() {
            <?php
                if($replaceText)
                {
                    $commentError = json_encode(array("comment" => "$commentProblem[comment]",
                                                      "parent"  => "$commentProblem[parentNum]"));
                    echo "replaceText($commentError);";
                }
            ?>
        });
    </script>
