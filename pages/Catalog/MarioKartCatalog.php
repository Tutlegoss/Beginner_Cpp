    ...
    <div class="container-fluid">
        <div class="row mt-5">
            ...
            <div class="col-12 mt-2">
                <p class="text-center fontMarioKart marioTitleSize marioKartTxtShade">
                    Super Mario Kart
                </p>
            </div>
        </div>
                ...
                <table class="table table-responsive text-center" id="marioVersTable">
                    <thead>
                        <tr class="text-center marioCheckTableImg">
                            ...
                            <th><img src="<?php echo "$headerData[Path]img/NoSymbol.jpg"; ?>" alt="No Symbol"></th>
                            <th><img src="<?php echo "$headerData[Path]img/TOTY.jpg"; ?>" alt="TOTY"></th>
                            <th><img src="<?php echo "$headerData[Path]img/3Plus.jpg"; ?>" alt="3+"></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
